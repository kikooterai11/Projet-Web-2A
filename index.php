  ...
  <main class="main">
    <div class="container">
      <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
        ...
        <form action="book-a-table.php" method="post" role="form" class="php-email-form">
        <div class="row gy-4">
              ...
              <div class="col-lg-4 col-md-6">
                <input type="date" class="form-control" name="check out" id="checkout" placeholder="Time" required="">
                </div>

                <div class="col-lg-4 col-md-6">
                <select name="room_type" class="form-control" id="room-type" placeholder="select room type" required>
